...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<pageViews.size();i++){
            ...
            if(i==0){
                imageViews[i].setBackgroundResource(R.drawable.point_solid);
            }else{
                imageViews[i].setBackgroundResource(R.drawable.point_hollow);
            }
...
//             // 测试页卡1内的按钮事件  
            if (position == 1) {  
                Button btn = (Button) v.findViewById(R.id.btn_nowin);  
    ...
    class GuidePageChangeListener implements OnPageChangeListener{
        ...
        public void onPageSelected(int position) {
            ...
            for(int i=0;i<imageViews.length;i++){ 
                imageViews[position].setBackgroundResource(R.drawable.point_solid);
